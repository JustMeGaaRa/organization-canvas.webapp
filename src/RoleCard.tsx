...
export const RoleCard = ({
    ...
    return (
        <div
            ...
            onDrop={handleDrop}
            className={`absolute ${cardWidth} ${cardHeight} border bg-white p-5 rounded-2xl flex flex-col transition-shadow select-none cursor-grab active:cursor-grabbing ${isDragging
